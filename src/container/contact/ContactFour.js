                        ...
                        <div className="bk-footer-widget">
                            ...
                            <div className="row minimal-home-address">
                                ...
                                <Col md={6} className="mt_sm--40">
                                    <div className="mini-address">
                                        <h4 className="heading heading-h4">Message me</h4>
                                        <div className="bk-separator--10"/>
